                    ...
                    Group {
                        ...
                        VStack(spacing: 40) {
                            ...
                            ForEach(0..<(movie.numberOfSeasons ?? 0), id: \.self) { season in
                                let currentSeasonLop = season + 1
                                
                                Button {
                                    self.selectedSeason = currentSeasonLop
                                    self.showSeasonPicker = false
                                } label: {
                                    Text("Season \(currentSeasonLop)")
                                        .foregroundColor(selectedSeason == currentSeasonLop ? .white : .gray)
                                        .bold()
                                        .font(selectedSeason == currentSeasonLop ? .title : .title2)
                                }
